...
public class FakeMedicineLocalDataSource implements MedicineDataSource {
    ...
    private static com.gautam.medicinetime.data.FakeMedicineLocalDataSource INSTANCE;
    ...
    public static com.gautam.medicinetime.data.FakeMedicineLocalDataSource getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new com.gautam.medicinetime.data.FakeMedicineLocalDataSource();
        }
        return INSTANCE;
    }
